export const tiimi1 = {
	...
	jasenet: [
		{
			nimi: "Jaiden",
			rooli: "graafikko, valokuvaaja",
			osaaminen: "Valo- ja videokuvaus, Photoshop",
			kuvaus: "Valokuvaaja, aviomies, isä ja innokas retkeilijä."
		},
		{
			nimi: "Jon",
			rooli: "Ohjelmoija",
			osaaminen: "HTML5/CSS3, Angular, PHP, MySQL, Linux-palvelimet",
		...
		},
		{
			nimi: "Rami",
			rooli: "Ohjelmoija",
			osaaminen: "HTML5/CSS3, Javascript Full Stack",
			kuvaus: "No comment."
		},
		{
			nimi: "Veera",
			rooli: "Projektipäällikkö, asiakasvastaava",
			osaaminen: "Projektijohtaminen, Javascript, React, Redux",
			kuvaus: "Asiakas voi olla samaan aikaan kuningas ja idiootti."
		}
	]
};
...
export const tyolajit = ["Määrittely", "Suunnittelu", "Toteutus", "Testaus", "Asiakastapaamiset"];
